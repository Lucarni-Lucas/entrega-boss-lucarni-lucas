...
#JUMP
@export var anim_estiramiento_factor: float = 0.00053
@export_range(1, 2, 0.05) var anim_estiramiento_max: float = 1.15
@export var anim_aterrizaje_escala := Vector2(1.3, 0.75)
@export_range(0, 0.5, 0.01, "suffix:s") var anim_aterrizaje_ida: float = 0.08
@export_range(0, 0.7, 0.01, "suffix:s") var anim_aterrizaje_vuelta: float = 0.49
#SLASH
...
@export_range(0, 0.5, 0.01, "suffix:s") var anim_rebote_ida: float = 0.07
@export_range(0, 0.5, 0.01, "suffix:s") var anim_rebote_vuelta: float = 0.27

@export_group("Caminar")
@export_range(0, 1000, 1, "suffix:px/s") var velocidad: float = 337.0

@export_group("Salto")
@export_range(0, 3000, 1, "suffix:px/s") var fuerza_salto: float = 975.0
...
@export_range(0, 1, 0.01, "suffix:s") var slash_duracion: float = 0.2
@export_range(0, 2, 0.01, "suffix:s") var slash_cooldown: float = 0.4
...
@export_range(0, 0.5, 0.01, "suffix:s") var gp_anticipacion: float = 0.29
...
@export_range(0, 2000, 1, "suffix:px/s") var dive_impulso_vertical: float = 400.0
@export_range(0, 1, 0.05) var dive_escala_gravedad: float = 1.0
@export var dive_cargas_max: int = 1

@export_group("Boomerang")
@export_range(0, 3000, 10, "suffix:px/s") var boomerang_velocidad: float = 900.0
@export_range(0, 1000, 10, "suffix:px") var boomerang_distancia: float = 190.0
@export_range(0, 5, 0.1, "suffix:s") var boomerang_duracion: float = 1.6
@export_range(0, 3000, 10, "suffix:px/s") var boomerang_velocidad_vuelta: float = 1050.0
@export_range(0, 1, 0.01, "suffix:s") var throw_duracion: float = 0.31
@export_range(0, 1, 0.05) var throw_factor_velocidad: float = 0.15
...
@export_group("Rebote")
@export_range(0, 4000, 1, "suffix:px/s") var vault_fuerza: float = 975.0
